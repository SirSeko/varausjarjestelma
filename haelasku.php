...
<div class ="container">
    ...
    <?php
        ...
        if ($lasku == "") {
            echo "<p>ei näytettäviä tietoja</p><br><a href='laskutusA.php'>Palaa</a>";
        } else {
    ...
    <div id="perustiedot" class="tiedot-container">
        ...
        <div class="muokkaa-nappi"><a href=<?php echo '"laskutusA.php?sivu=muokkaalaskua&id='. $lasku->getLaskuId() . '"';?>>Muokkaa</a></div>
